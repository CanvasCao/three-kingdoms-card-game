...
let testCardMetaList = [
    ...
    // {'huase': CARD_HUASE.CAOHUA, number: 5, key: CARD_CONFIG.QI_LIN_GONG.key},
    // {'huase': CARD_HUASE.FANGKUAI, number: 12, key: CARD_CONFIG.QIN_GANG_JIAN.key},
    {'huase': CARD_HUASE.FANGKUAI, number: 12, key: CARD_CONFIG.CI_XIONG_SHUANG_GU_JIAN.key},
    {'huase': CARD_HUASE.FANGKUAI, number: 12, key: CARD_CONFIG.CI_XIONG_SHUANG_GU_JIAN.key},
    {'huase': CARD_HUASE.FANGKUAI, number: 12, key: CARD_CONFIG.CI_XIONG_SHUANG_GU_JIAN.key},
    {'huase': CARD_HUASE.FANGKUAI, number: 12, key: CARD_CONFIG.CI_XIONG_SHUANG_GU_JIAN.key},
    {'huase': CARD_HUASE.FANGKUAI, number: 12, key: CARD_CONFIG.GUAN_SHI_FU.key},
    {'huase': CARD_HUASE.FANGKUAI, number: 12, key: CARD_CONFIG.GUAN_SHI_FU.key},
    {'huase': CARD_HUASE.FANGKUAI, number: 12, key: CARD_CONFIG.GUAN_SHI_FU.key},
    {'huase': CARD_HUASE.FANGKUAI, number: 12, key: CARD_CONFIG.GUAN_SHI_FU.key},
    // {'huase': CARD_HUASE.FANGKUAI, number: 12, key: CARD_CONFIG.HAN_BIN_JIAN.key},
...
const metaList = process.env.NODE_ENV == 'production' ? standardCardMetaList : standardCardMetaList// testCardMetaList;
